...
func TestRuntimeLockPinsClosedPlatformAndLicenseInventory(t *testing.T) {
	...
	if lock.WorkbenchVersion != "0.2.0" {
		t.Fatalf("WorkbenchVersion = %q, want 0.2.0", lock.WorkbenchVersion)
	}
...
func TestAssetNameUsesMiseNativePlatformTokens(t *testing.T) {
	tests := map[string]Platform{
		"workbench-0.2.0-macos-arm64.tar.gz": {OS: "darwin", Arch: "arm64"},
		"workbench-0.2.0-macos-x64.tar.gz":   {OS: "darwin", Arch: "amd64"},
		"workbench-0.2.0-linux-arm64.tar.gz": {OS: "linux", Arch: "arm64"},
		"workbench-0.2.0-linux-x64.tar.gz":   {OS: "linux", Arch: "amd64"},
	}
	for want, platform := range tests {
		got, err := AssetName("0.2.0", platform)
		if err != nil {
...
func TestWriteArchiveIsByteDeterministicAndHasClosedLayout(t *testing.T) {
	...
	want := []string{
		"workbench-0.2.0/",
		"workbench-0.2.0/bin/",
		"workbench-0.2.0/bin/workbench",
		"workbench-0.2.0/libexec/",
		"workbench-0.2.0/libexec/workbench/",
		"workbench-0.2.0/libexec/workbench/bun",
		"workbench-0.2.0/libexec/workbench/pkl",
		"workbench-0.2.0/share/",
		"workbench-0.2.0/share/licenses/",
		"workbench-0.2.0/share/licenses/bun/",
		"workbench-0.2.0/share/licenses/bun/LICENSE.md",
		"workbench-0.2.0/share/licenses/go/",
		"workbench-0.2.0/share/licenses/go/LICENSE",
		"workbench-0.2.0/share/licenses/go/PATENTS",
		"workbench-0.2.0/share/licenses/msgpack/",
		"workbench-0.2.0/share/licenses/msgpack/LICENSE",
		"workbench-0.2.0/share/licenses/pkl-go/",
		"workbench-0.2.0/share/licenses/pkl-go/LICENSE.txt",
		"workbench-0.2.0/share/licenses/pkl-go/NOTICE.txt",
		"workbench-0.2.0/share/licenses/pkl/",
		"workbench-0.2.0/share/licenses/pkl/LICENSE.txt",
		"workbench-0.2.0/share/licenses/pkl/NOTICE.txt",
		"workbench-0.2.0/share/licenses/pkl/THIRD-PARTY-NOTICES.txt",
		"workbench-0.2.0/share/licenses/tagparser/",
		"workbench-0.2.0/share/licenses/tagparser/LICENSE",
		"workbench-0.2.0/share/licenses/workbench/",
		"workbench-0.2.0/share/licenses/workbench/LICENSE",
		"workbench-0.2.0/share/workbench/",
		"workbench-0.2.0/share/workbench/build.json",
		"workbench-0.2.0/share/workbench/runtime-lock.json",
	}
