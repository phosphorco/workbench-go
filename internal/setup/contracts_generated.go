...
typealias GitHubRepositoryUrl = String(
  matches(Regex(#"https://github\.com/[A-Za-z0-9_.-]+/[A-Za-z0-9_.-]+(?:\.git)?"#))
)
...
/// Only dependency semantics that source imports cannot derive.
class PackagePolicy {
